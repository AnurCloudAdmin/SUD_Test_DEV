...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/mar/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/mar/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('प्लान नाव', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('लाइफ कव्हर / सम अश्युअर्ड', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('विमाधारकाचे नाव', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('प्रीमियम रक्कम', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('प्रीमियम भरण्याचा कालावधी', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('पॉलिसी टर्म', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('फ्रिक्वेंसी', COMMON_IMAGE_PATH + 'frequency_icon.png');
