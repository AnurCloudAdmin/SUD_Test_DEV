...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/ben/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/ben/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    game.load.image('allow_access_camera', COMMON_IMAGE_PATH + 'allow_access_btn.png');
    game.load.image('allow_access_location', COMMON_IMAGE_PATH + 'allow_access_btn.png');
    ...
    //Plan details ICONS
    game.load.image('পরিকল্পনার নাম', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('জীবন কভার / নিশ্চিত পরিমাণ', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('জীবন বীমিত ব্যক্তির নাম', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('প্রিমিয়াম পরিমাণ', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('প্রিমিয়াম প্রদানকাল', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('পলিসি মেয়াদ', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('সাময়িকতা', COMMON_IMAGE_PATH + 'frequency_icon.png');
