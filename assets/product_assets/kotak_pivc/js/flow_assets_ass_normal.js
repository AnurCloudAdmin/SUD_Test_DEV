...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/ass/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/ass/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('প্লেন নাম', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('জীৱন সুৰক্ষা / নিশ্চিত ধন', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('জীৱন বীমাকৰ্তাৰ নাম', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('প্ৰিমিয়ামৰ পৰিমাণ', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('প্ৰিমিয়াম পৰিশোধৰ সময়সীমা', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('পলিচি ম্যাদ', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('সঘনতা', COMMON_IMAGE_PATH + 'frequency_icon.png')
