...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/tel/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/tel/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('ప్లాన్ పేరు', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('లైఫ్ కవర్ / సమ్ అష్యూర్డ్', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('లైఫ్ ఇన్షూర్డ్ పేరు', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('ప్రీమియం మొత్తం', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('ప్రీమియం చెల్లింపు కాలం', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('పాలసీ కాలం', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('వ్యవధి', COMMON_IMAGE_PATH + 'frequency_icon.png');
