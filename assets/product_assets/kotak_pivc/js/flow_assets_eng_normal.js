...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('Plan Name', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('Life Covered / Sum Assured', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('Life Insured Name', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('Premium Amount', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('Premium Paying Term', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('Policy Term', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('Frequency', COMMON_IMAGE_PATH + 'frequency_icon.png');
    ...
    game.load.image('green_box_tick', COMMON_IMAGE_PATH + 'green_box_tick.png');
    game.load.image('red_box_cancel', COMMON_IMAGE_PATH + 'red_box_cancel.png');
