...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/mal/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/mal/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('പ്ലാനിന്റെ പേര്', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('ജീവിത പരിരക്ഷ / സം അഷ്യൂര്‍ഡ്', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('ഇന്‍ഷ്വര്‍ഡ് ചെയ്ത വ്യക്തിയുടെ പേര്', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('പ്രീമിയം തുക', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('പ്രീമിയം അടയ്ക്കുന്ന കാലാവധി', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('പോളിസി കാലാവധി', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('തവണകള്‍', COMMON_IMAGE_PATH + 'frequency_icon.png');
