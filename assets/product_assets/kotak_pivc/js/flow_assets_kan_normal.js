...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/kan/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/kan/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('ಪ್ಲಾನ್ ಹೆಸರು', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('ಜೀವ ವಿಮಾ / ವಿಮಾ ಮೊತ್ತ', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('ಜೀವ ವಿಮೆ ಮಾಡಿದವರ ಹೆಸರು', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('ಪ್ರೀಮಿಯಂ ಮೊತ್ತ', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('ಪ್ರೀಮಿಯಂ ಪಾವತಿಸುವ ಅವಧಿ', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('ಪಾಲಿಸಿ ಅವಧಿ', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('ಫ್ರಿಕ್ವೆನ್ಸಿ', COMMON_IMAGE_PATH + 'frequency_icon.png');
