...

{
    ...
    "sound_list": [{
        "sound": ["product_kotak",
            // "premium_of", "$var.currency_window.res_params.PREMIUM_AMOUNT", "payment_frequency", "for", "$var.years_window.res_params.PREMIUM_PAYING_TERM", "policy_term", "$var.years_window.res_params.POLICY_TERM", "sum_assured", '$var.currency_window.res_params.SUM_ASSURED'
        ]
    }],
...

{
    ...
    "sprite_animations": [
        ...
        },
        {
            ...
            "scale": 0.8,
            "alpha": 0,
            "onClickFn": "BeginRecording()" //"start_photo_detections_1()"    //"()" "BeginRecording()"
        },
        {
            "sprite": "position_box",
            "x": 540,
