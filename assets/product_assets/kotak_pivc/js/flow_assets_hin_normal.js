...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/hin/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/hin/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    game.load.image('right_disable', COMMON_IMAGE_PATH + 'right_disable.png');
    game.load.image('left_disable', COMMON_IMAGE_PATH + 'left_disable.png');


    //Plan details ICONS
    game.load.image('प्लान का नाम', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('जीवन कवर / सुनिश्चित राशि', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('जीवन बीमित का नाम', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('प्रीमियम राशि', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('प्रिमियम भुगतान अवधि', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('पॉलिसी अवधि', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('आवृत्ति', COMMON_IMAGE_PATH + 'frequency_icon.png');
