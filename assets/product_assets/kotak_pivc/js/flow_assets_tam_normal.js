...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/tam/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/tam/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('ப்ளான் பெயர்', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('உயிர் காப்பீடு / உத்தரவாத தொகை', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('உயிர் காப்பீட்டாளரின் பெயர்', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('பிரீமியம் தொகை', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('பிரீமியம் செலுத்தும் காலம்', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('பாலிசி காலம்', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('தவணை முறை', COMMON_IMAGE_PATH + 'frequency_icon.png');
