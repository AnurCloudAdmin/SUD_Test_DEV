...
var PRODUCT_SCENE_AUDIO_PATH = PRODUCT_PATH + 'audio/ori/scenes/';  //Audio for all pages
...
var TYPE_COMMON_AUDIO_PATH = './assets/audio/product/ori/common/';  //dynamic values
...
function load_assets_init_images() {
    ...
    //Plan details ICONS
    game.load.image('ପ୍ଲାନ ନାମ', COMMON_IMAGE_PATH + 'plan_icon.png');
    game.load.image('ଲାଇଫ କଭର / ସମ ଆସୁର୍ଡ', COMMON_IMAGE_PATH + 'sum_assured_icon.png');
    game.load.image('ଲାଇଫ ଇନସୁର୍ଡ ନାମ', COMMON_IMAGE_PATH + 'life_insured_icon.png');
    game.load.image('ପ୍ରିମିୟମ ରାଶି', COMMON_IMAGE_PATH + 'premium_amount_icon.png');
    game.load.image('ପ୍ରିମିୟମ ପେଇଙ୍ଗ ଟର୍ମ', COMMON_IMAGE_PATH + 'premium_paying_term.png');
    game.load.image('ପଲିସି ଟର୍ମ', COMMON_IMAGE_PATH + 'policy_term_icon.png');
    game.load.image('ଫ୍ରିକ୍ୱେନସି', COMMON_IMAGE_PATH + 'frequency_icon.png');
